...
//액션 타입
const ADD_ITEM = 'playlist/ADD_ITEM'
const ADD_PLAYLIST = 'playlist/ADD_PLAYLIST'
const GET_PLAYLIST = 'playlist/GET_PLAYLIST'
const GET_PLAYLIST_ASYNC = 'playlist/GET_PLAYLIST_ASYNC'
const CLEAR_THUMBNAIL = 'playlist/CLEAR_THUMBNAIL'
const SET_THUMBNAIL = 'playlist/SET_THUMBNAIL'
